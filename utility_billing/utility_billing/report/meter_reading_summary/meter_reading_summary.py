            ...
            if rates:
                for i, rate in enumerate(rates):
                    data.append(
                        {
                            "name": (
                                reading.name if not reading_printed and i == 0 else ""
                            ),
                            "type": "Rate",
                            "date": (
                                reading.date if not reading_printed and i == 0 else ""
                            ),
                            "customer": (
                                reading.customer
                ...
                data.append(
                    {
                        ...
                        "utility_property": (
                            reading.utility_property if not reading_printed else ""
                        ),
